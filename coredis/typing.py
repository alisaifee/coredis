...
class TypeAdapter:
    ...
    def __init__(
        self,
        serializers: dict[type | UnionType, Callable[[Any], RedisValueT]] | None = None,
        deserializers: dict[type | UnionType, dict[type | UnionType, Callable[..., Any]]]
        | None = None,
    ) -> None:
        self.__serializers: dict[type | UnionType, Callable[[Any], RedisValueT]] = serializers or {}
        self.__deserializers: dict[type | UnionType, dict[type | UnionType, Callable[..., Any]]] = (
            deserializers or {}
        )
