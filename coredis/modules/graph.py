...
class Graph(ModuleGroup[AnyStr]):
    ...
    ) -> CommandTask[GraphQueryResult[AnyStr]]:
        """
    ...
    def delete(self, graph: KeyT) -> CommandTask[bool]:
        """
    ...
    def explain(self, graph: KeyT, query: StringT) -> CommandTask[list[AnyStr]]:
        """
        ...
        return CommandTask(
            self.client, CommandName.GRAPH_EXPLAIN, graph, query, callback=ListCallback[AnyStr]()
        )
    ...
    ) -> CommandTask[tuple[GraphSlowLogInfo, ...]] | CommandTask[bool]:
        """
    ...
    def config_get(
        self, name: StringT
    ) -> CommandTask[dict[AnyStr, ResponsePrimitive] | ResponsePrimitive]:
        """
    ...
    def config_set(self, name: StringT, value: ValueT) -> CommandTask[bool]:
        """
        ...
        """
        return CommandTask(
            self.client, CommandName.GRAPH_CONFIG_SET, name, value, callback=SimpleStringCallback()
        )
    ...
    def list(self) -> CommandTask[set[AnyStr]]:
        ...
        return CommandTask(self.client, CommandName.GRAPH_LIST, callback=SetCallback[AnyStr]())
