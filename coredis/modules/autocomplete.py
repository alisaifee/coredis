...
from ..commands._wrappers import CommandTask
...
class Autocomplete(ModuleGroup[AnyStr]):
    ...
    def sugadd(
        ...
        return CommandTask(
            self.client, CommandName.FT_SUGADD, *command_arguments, callback=IntCallback()
        )
        ...
        *,
    ...
    ) -> CommandTask[tuple[AutocompleteSuggestion[AnyStr], ...] | tuple[()]]:
        """
        ...
        return CommandTask(
            ...
            *command_arguments,
            ...
            callback_options={"withscores": withscores, "withpayloads": withpayloads},
        )
    ...
    def sugdel(self, key: KeyT, string: StringT) -> CommandTask[bool]:
        """
        ...
        return CommandTask(
            self.client, CommandName.FT_SUGDEL, *command_arguments, callback=BoolCallback()
        )
    ...
    def suglen(self, key: KeyT) -> CommandTask[int]:
        """
        ...
        return CommandTask(
            self.client, CommandName.FT_SUGLEN, *command_arguments, callback=IntCallback()
        )
