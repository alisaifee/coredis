...
class Pipeline(ObjectProxy, Generic[AnyStr]):  # type: ignore
    ...
    async def zrank(self, key: "KeyT", member: "ValueT") -> Pipeline[AnyStr]: ...
    async def zrem(
        self, key: "KeyT", members: "Parameters[ValueT]"
    ) -> Pipeline[AnyStr]: ...
    ...
    async def zrevrank(self, key: "KeyT", member: "ValueT") -> Pipeline[AnyStr]: ...
    async def zscan(
        self,
        key: "KeyT",
        cursor: "Optional[int]" = ...,
...
class ClusterPipeline(ObjectProxy, Generic[AnyStr]):  # type: ignore
    ...
    async def zrank(self, key: "KeyT", member: "ValueT") -> ClusterPipeline[AnyStr]: ...
    async def zrem(
        self, key: "KeyT", members: "Parameters[ValueT]"
    ) -> ClusterPipeline[AnyStr]: ...
    async def zremrangebylex(
