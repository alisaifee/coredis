...
class Pipeline(ObjectProxy, Generic[AnyStr]):  # type: ignore
    ...
    async def vadd(
        ...
        reduce: "int | None" = ...,
        cas: "bool | None" = ...,
        quantization: "Literal[PureToken.BIN, PureToken.NOQUANT, PureToken.Q8] | None" = ...,
        ef: "int | None" = ...,
        attributes: "JsonType | None" = ...,
        numlinks: "int | None" = ...,
    ) -> Pipeline[AnyStr]: ...
    async def vrem(self, key: "KeyT", element: "ValueT") -> Pipeline[AnyStr]: ...
    async def vsim(
        self,
        key: "KeyT",
    ...
    async def vdim(self, key: "KeyT") -> Pipeline[AnyStr]: ...
    async def vcard(self, key: "KeyT") -> Pipeline[AnyStr]: ...
    async def vemb(
        self, key: "KeyT", element: "StringT", raw: "bool | None" = ...
    ) -> Pipeline[AnyStr]: ...
    async def vlinks(
        self, key: "KeyT", element: "StringT", withscores: "bool | None" = ...
    ) -> Pipeline[AnyStr]: ...
    async def vinfo(self, key: "KeyT") -> Pipeline[AnyStr]: ...
    async def vsetattr(
        self, key: "KeyT", element: "StringT", attributes: "JsonType"
    ) -> Pipeline[AnyStr]: ...
    async def vgetattr(self, key: "KeyT", element: "StringT") -> Pipeline[AnyStr]: ...
    async def vrandmember(self, key: "KeyT", count: "int | None" = ...) -> Pipeline[AnyStr]: ...
...
class ClusterPipeline(ObjectProxy, Generic[AnyStr]):  # type: ignore
    ...
    async def vrem(self, key: "KeyT", element: "ValueT") -> ClusterPipeline[AnyStr]: ...
    async def vsim(
        self,
        key: "KeyT",
        element: "StringT | None" = ...,
    ...
    async def vdim(self, key: "KeyT") -> ClusterPipeline[AnyStr]: ...
    async def vcard(self, key: "KeyT") -> ClusterPipeline[AnyStr]: ...
    async def vemb(
        self, key: "KeyT", element: "StringT", raw: "bool | None" = ...
    ) -> ClusterPipeline[AnyStr]: ...
    async def vlinks(
    ...
    async def vinfo(self, key: "KeyT") -> ClusterPipeline[AnyStr]: ...
    async def vsetattr(
        self, key: "KeyT", element: "StringT", attributes: "JsonType"
    ) -> ClusterPipeline[AnyStr]: ...
    async def vgetattr(self, key: "KeyT", element: "StringT") -> ClusterPipeline[AnyStr]: ...
