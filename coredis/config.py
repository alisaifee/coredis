...
class __Config:
    ...
    def otel_disabled_commands(self) -> list[bytes]:
        ...
        """
        return self.__otel_disabled_commands

    @otel_disabled_commands.setter
    def otel_disabled_commands(self, value: list[str | bytes]) -> None:
        from coredis._utils import b

        self.__otel_disabled_commands = [b(cmd.strip()) for cmd in value]
