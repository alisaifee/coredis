...
class KeySpec:
    ...
    ALL: ClassVar[dict[bytes, Callable[[tuple[RedisValueT, ...]], tuple[RedisValueT, ...]]]] = {
        b"VADD": lambda args: (args[0],),
        b"VREM": lambda args: (args[0],),
        b"VSIM": lambda args: (args[0],),
        b"VDIM": lambda args: (args[0],),
        b"VCARD": lambda args: (args[0],),
        b"VEMB": lambda args: (args[0],),
        b"VLINKS": lambda args: (args[0],),
        b"VINFO": lambda args: (args[0],),
        b"VSETATTR": lambda args: (args[0],),
        b"VGETATTR": lambda args: (args[0],),
        b"VRANDMEMBER": lambda args: (args[0],),
        b"VISMEMBER": lambda args: (args[0],),
        b"VRANGE": lambda args: (args[0],),
