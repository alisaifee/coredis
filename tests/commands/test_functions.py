...
class TestLibrary:
    ...
    async def test_subclass_wrap(selfself, client, simple_library, _s):
        class Coredis(Library):
            ...
            async def return_arg(self, value: RedisValueT) -> RedisValueT: ...

            @Library.wraps("default_get")
            async def default_get(self, key: KeyT, value: RedisValueT) -> RedisValueT: ...
            ...
            async def hmmerge(self, key: KeyT, **values: RedisValueT) -> list[RedisValueT]: ...
    ...
    async def test_subclass_wrap_ro_forced(
        ...
        class Coredis(Library):
            ...
            async def return_arg_ro(self, value: RedisValueT) -> RedisValueT: ...
